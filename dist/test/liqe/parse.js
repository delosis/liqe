...
const testQuery = (t, expectedAst) => {
    const ast = (0, parse_1.parse)(t.title);
    t.deepEqual(ast, expectedAst);
};
(0, ava_1.default)('error describes offset', (t) => {
    const error = t.throws(() => {
        (0, parse_1.parse)('foo &');
    });
    t.true(error instanceof errors_1.SyntaxError);
    t.is(error.offset, 4);
    t.is(error.line, 1);
    t.is(error.column, 5);
});
(0, ava_1.default)('empty query', (t) => {
    t.deepEqual((0, parse_1.parse)(''), {
        location: {
            end: 0,
            start: 0,
        },
...
(0, ava_1.default)('empty query (whitespace)', (t) => {
    t.deepEqual((0, parse_1.parse)('  '), {
        location: {
            end: 0,
            start: 0,
...
(0, ava_1.default)('foo123', testQuery, {
    expression: {
        location: {
            end: 6,
            start: 0,
...
(0, ava_1.default)('foo with whitespace at the start', (t) => {
    t.deepEqual((0, parse_1.parse)(' foo'), {
        expression: {
            location: {
                end: 4,
                start: 1,
...
(0, ava_1.default)('foo with whitespace at the end', (t) => {
    t.deepEqual((0, parse_1.parse)('foo '), {
        expression: {
            location: {
                end: 3,
...
(0, ava_1.default)('foo:b', testQuery, {
    expression: {
        location: {
            end: 5,
            start: 4,
...
(0, ava_1.default)('foo:bar@baz.com', testQuery, {
    expression: {
        location: {
            end: 15,
            start: 4,
...
(0, ava_1.default)('foo:bar123', testQuery, {
    expression: {
        location: {
            end: 10,
            start: 4,
...
(0, ava_1.default)('foo:测试', testQuery, {
    expression: {
        location: {
            end: 6,
            start: 4,
...
(0, ava_1.default)('( foo OR bar AND baz )', testQuery, {
    expression: {
        left: {
            left: {
                expression: {
