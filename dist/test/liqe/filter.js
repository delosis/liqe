...
const testQuery = ava_1.default.macro((t, expectedResultNames, options) => {
    const matchingPersonNames = (0, filter_1.filter)((0, parse_1.parse)(t.title), persons, options).map((person) => {
        return person.name;
    });
...
(0, ava_1.default)("name:/(David)|(John)/", testQuery, [], { caseSensitive: true });
